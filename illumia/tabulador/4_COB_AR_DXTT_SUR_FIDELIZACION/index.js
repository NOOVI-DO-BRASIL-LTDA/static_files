...
const typificationOptionsData = {
  "CIERRE DE GESTION": {
    ...
    "No Acepta Condonacion": [
      "Suscriptor fallecido",
      "Mensaje con tercero",
      "Suspender gestion",
      "Suscriptor Reporta pago",
      "Pago no aplicado",
      "Suscriptor con Ajustes o reclamo pendiente",
      "Suscriptor al dia sin gestion",
      "Suscriptor al dia con gestion"
    ],
...
const motivoOptionsData = {
  "CIERRE DE GESTION": {
    "No Acepta / Fuera de politica": {
      ...
      "Facturacion": [
        "No coincide vencimiento de factura con flujo de caja",
        "Novedades en la recepción de la factura",
      ...
      "Servicio": [
        ...
        "Pendiente de Cancelation u oferta de retención",
        "Informacion errada em la venta/servicio",
        "Incovenientes con el recuado"
      ],
      "Otros": [
...
const lugarValues = ["Banco", "Cajero Automatico", "Debito Automatico", "Edsur", "Internet", "Otro", "Pago Electronico", "Pago Telefonico"]
