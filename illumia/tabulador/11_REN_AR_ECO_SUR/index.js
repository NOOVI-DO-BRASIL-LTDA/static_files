...
const typificationOptionsData = {
  "CIERRE DE GESTION": {
    ...
    "No Venta": [],
    "No aplica gestion": [
      "No cumple condiciones edilicias",
      "No cumple requisito edad",
      "Vivienda no habitada",
      "Cte corporativo empresa",
      "Cliente con deuda",
      "CTE prepago",
      "Em proceso de cancelacion",
      "Ya tiene producto seguro Hogar"
    ],
    "Ya gestionado": []
  },
  "RELLAMAR": [
